...
public class VehicleDetails extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        RepairAdd = new javax.swing.JButton();
        RestoreAdd = new javax.swing.JButton();
        ...
        RepairAdd.setBackground(new java.awt.Color(255, 0, 0));
        RepairAdd.setForeground(new java.awt.Color(255, 255, 255));
        RepairAdd.setText("Repair");
        RepairAdd.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                RepairAddActionPerformed(evt);
            }
        });

        RestoreAdd.setBackground(new java.awt.Color(255, 255, 255));
        RestoreAdd.setForeground(new java.awt.Color(255, 51, 0));
        RestoreAdd.setText("Restoration");
        RestoreAdd.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                RestoreAddActionPerformed(evt);
            }
        });

        jLabel6.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
        jLabel6.setForeground(new java.awt.Color(255, 255, 255));
        jLabel6.setText("Owners Email");
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                ...
                .addComponent(RepairAdd)
                .addGap(66, 66, 66)
                .addComponent(RestoreAdd)
                .addGap(24, 24, 24))
        );
    ...
    private void RepairAddActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_RepairAddActionPerformed
      try{
        Class.forName(driver);
        Connection con=DriverManager.getConnection(url, user, password);
        String sql="insert into Vehicle "
                +"(VID,Vtype,VIssue,OEmail,JobID)"
                +"values(?,?,?,?,?)";
        ...
        pst.setString(4, txtOEmail.getText());
       pst.setString(5,txtJobID.getText());
        
        pst.executeUpdate();
        JOptionPane.showMessageDialog(this, "Vehicle Added to Repair section Successfully");
        
        RepairGUI rf= new RepairGUI();
            rf.setVisible(true);
    ...
    }//GEN-LAST:event_RepairAddActionPerformed

    private void RestoreAddActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_RestoreAddActionPerformed
          try{
        Class.forName(driver);
        Connection con=DriverManager.getConnection(url, user, password);
        String sql="insert into Vehicle "
                +"(VID,Vtype,VIssue,OEmail)"
                +"values(?,?,?,?,?)";
        PreparedStatement pst=con.prepareStatement(sql);
        pst.setString(1,txtVID.getText() );
        pst.setString(2, txtVtype.getText());
        ...
        pst.executeUpdate();
        JOptionPane.showMessageDialog(this, "Vehicle Added to Restoration section Successfully");
        
        RestorationUI res = new RestorationUI();
            res.setVisible(true);
            this.setVisible(false);
        ...
        // TODO add your handling code here:
    }//GEN-LAST:event_RestoreAddActionPerformed
...
//    }
    ...
    private javax.swing.JButton RepairAdd;
    private javax.swing.JButton RestoreAdd;
